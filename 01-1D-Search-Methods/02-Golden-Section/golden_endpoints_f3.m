...
gamma = 0.618; % Τιμή του γ για τη μέθοδο του Χρυσού Τομέα
...
title('Values of a_k and b_k for f3(x) using Golden Section Search');
legend show;
grid on;
hold off;
